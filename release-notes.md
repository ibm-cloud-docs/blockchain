...
Use these release notes to learn about the latest changes to {{site.data.keyword.blockchainfull}} Platform  {{site.data.keyword.cloud_notm}}built on Hyperledger Fabric [v2.2.12](https://github.com/hyperledger/fabric/releases/tag/v2.2.12), [v2.4.9](https://github.com/hyperledger/fabric/releases/tag/v2.4.9) and [v2.5.3](https://github.com/hyperledger/fabric/releases/tag/v2.5.3).
...
**Certificate Authority (CA) patch 1.5.5-15, Peer and ordering node patch 2.2.12-2, 2.4.9-4, 2.5.3-2.**

Couch DB upgraded from v3.2.2 to v3.3.2 
...
**Certificate Authority (CA) patch 1.5.5-14, Peer and ordering node patch 2.2.12-1, 2.4.9-3, 2.5.3-1.**
...
**Certificate Authority (CA) patch 1.5.5-13, Peer and ordering node patch 2.2.11-2, 2.4.9-2, 2.5.1-1.**
...
**Certificate Authority (CA) patch 1.5.5-12, Peer and ordering node patch 2.2.11-1, 2.4.9-1.**
...
**Certificate Authority (CA) patch 1.5.5-11, Peer and ordering node patch 2.2.10-3, 2.4.8-3.**
