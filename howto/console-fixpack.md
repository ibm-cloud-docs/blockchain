...
```
kubectl set image deploy/ibp-webhook -n ibpinfra ibp-webhook=cp.icr.io/cp/ibp-crdwebhook:2.5.3-20220622-amd64
```
{: codeblock}
...
```
kubectl set image deploy/ibp-operator -n <namespace> ibp-operator=cp.icr.io/cp/ibp-operator:2.5.3-20220622-amd64
```
{: codeblock}
...
skopeo copy docker://cp.icr.io/cp/ibp-couchdb:3.1.2-20220601 docker://<LOCAL_REGISTRY>/ibp-couchdb:3.1.2-20220601 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibp-couchdb:3.1.2-20220601 docker://<LOCAL_REGISTRY>/ibp-couchdb:3.1.2-20220601 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
