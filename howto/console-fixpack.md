...
skopeo copy docker://cp.icr.io/cp/ibp-peer:1.4.12-24230322-amd64 docker://<LOCAL_REGISTRY>/ibp-peer:1.4.12-24230322-amd64 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibp-orderer:1.4.12-24230322-amd64 docker://<LOCAL_REGISTRY>/ibp-orderer:1.4.12-24230322-amd64 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
...
skopeo copy docker://cp.icr.io/cp/ibp-dind:1.4.12-24230322-amd64 docker://<LOCAL_REGISTRY>/ibp-dind:1.4.12-24230322-amd64 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibp-utilities:1.4.12-24230322-amd64 docker://<LOCAL_REGISTRY>/ibp-utilities:1.4.12-24230322-amd64 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
...
skopeo copy docker://cp.icr.io/cp/ibp-ccenv:1.4.12-24230322-amd64 docker://<LOCAL_REGISTRY>/ibp-ccenv:1.4.12-24230322-amd64 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibp-goenv:1.4.12-24230322-amd64 docker://<LOCAL_REGISTRY>/ibp-goenv:1.4.12-24230322-amd64 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibp-nodeenv:1.4.12-24230322-amd64 docker://<LOCAL_REGISTRY>/ibp-nodeenv:1.4.12-24230322-amd64 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibp-javaenv:1.4.12-24230322-amd64 docker://<LOCAL_REGISTRY>/ibp-javaenv:1.4.12-24230322-amd64 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
