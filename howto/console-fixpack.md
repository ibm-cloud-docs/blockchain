...
```
skopeo copy docker://cp.icr.io/cp/ibp-operator:2.5.3-20220816 docker://<LOCAL_REGISTRY>/ibp-operator:2.5.3-20220816 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibp-init:2.5.3-20220816 docker://<LOCAL_REGISTRY>/ibp-init:2.5.3-20220816 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibp-console:2.5.3-20220816 docker://<LOCAL_REGISTRY>/ibp-console:2.5.3-20220816 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibp-grpcweb:2.5.3-20220816 docker://<LOCAL_REGISTRY>/ibp-grpcweb:2.5.3-20220816 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibp-deployer:2.5.3-20220816 docker://<LOCAL_REGISTRY>/ibp-deployer:2.5.3-20220816 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
skopeo copy docker://cp.icr.io/cp/ibp-fluentd:2.5.3-20220816 docker://<LOCAL_REGISTRY>/ibp-fluentd:2.5.3-20220816 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
...
skopeo copy docker://cp.icr.io/cp/ibp-crdwebhook:2.5.3-20220816 docker://<LOCAL_REGISTRY>/ibp-crdwebhook:2.5.3-20220816 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
...
skopeo copy docker://cp.icr.io/cp/ibp-enroller:2.5.3-20220816 docker://<LOCAL_REGISTRY>/ibp-enroller:2.5.3-20220816 -q --src-creds cp:<ENTITLEMENT_KEY> --dest-creds <LOCAL_REGISTRY_USER>:<LOCAL_REGISTRY_PASSWORD> --all
```
{: codeblock}
